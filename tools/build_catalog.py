...
ESSENTIALS: list[tuple[str, str, str]] = [
    ...
    # repo transferred to micro-editor/micro, but keep the old owner/repo
    # here — it must match awesome-tuis's own (also stale) URL exactly or
    # the dedupe-by-slug check below stops recognizing this as the same
    # entry and creates a second "micro" listing.
    ...
    # same deal as micro above — repo transferred to gitui-org/gitui, but
    ...
    # cli.masoko.net (The Terminal Index) — swept 2026-07-20, cross-checked
    # against every existing catalog repo (incl. GitHub org-transfer
    # redirects) to skip anything already covered above or in awesome-tuis.
    ("AetherTune", "https://github.com/nevermore23274/AetherTune", "Multimedia"),
    ("age", "https://github.com/FiloSottile/age", "Miscellaneous"),
    ("archivemount", "https://github.com/cybernoid/archivemount", "CLI Tools"),
    ("ascii-patrol", "https://github.com/msokalski/ascii-patrol", "Games"),
    ("byobu", "https://github.com/dustinkirkland/byobu", "Productivity"),
    ("cliflux", "https://github.com/spencerwi/cliflux", "Productivity"),
    ("cloc", "https://github.com/AlDanial/cloc", "CLI Tools"),
    ("cloudlens", "https://github.com/one2nc/cloudlens", "Development"),
    ("countdown", "https://github.com/antonmedv/countdown", "Miscellaneous"),
    ("diffnav", "https://github.com/dlvhdr/diffnav", "Development"),
    ("ditto", "https://github.com/arvingarciabtw/ditto", "Multimedia"),
    ("dnsglobe", "https://github.com/514-labs/dnsglobe", "Dashboards"),
    ("dutree", "https://github.com/nachoparker/dutree", "CLI Tools"),
    ("dyff", "https://github.com/homeport/dyff", "CLI Tools"),
    ("dz6", "https://github.com/mentebinaria/dz6", "Miscellaneous"),
    ("elio", "https://github.com/elio-fm/elio", "File Managers"),
    ("flyline", "https://github.com/HalFrgrd/flyline", "Productivity"),
    ("FTB", "https://github.com/Cyxuan0311/FTB", "File Managers"),
    ("g", "https://github.com/Equationzhao/g", "CLI Tools"),
    ("gh-enhance", "https://github.com/dlvhdr/gh-enhance", "Development"),
    ("ghgrab", "https://github.com/abhixdd/ghgrab", "Development"),
    ("herdr", "https://github.com/ogulcancelik/herdr", "Development"),
    ("hexyl", "https://github.com/sharkdp/hexyl", "Miscellaneous"),
    ("inshellisense", "https://github.com/microsoft/inshellisense", "Productivity"),
    ("jbang", "https://github.com/jbangdev/jbang", "Development"),
    ("jnv", "https://github.com/ynqa/jnv", "CLI Tools"),
    ("lazyskills", "https://github.com/alvinunreal/lazyskills", "Development"),
    ("lla", "https://github.com/chaqchase/lla", "CLI Tools"),
    ("logo-ls", "https://github.com/Yash-Handa/logo-ls", "CLI Tools"),
    ("lstr", "https://github.com/bgreenwell/lstr", "CLI Tools"),
    ("lyrtui", "https://github.com/hjelev/lyrtui", "Multimedia"),
    ("metropolis", "https://github.com/5c0/metropolis", "Multimedia"),
    ("mise", "https://github.com/jdx/mise", "Development"),
    ("mocp", "https://github.com/jonsafari/mocp", "Multimedia"),
    ("mpv", "https://github.com/mpv-player/mpv", "Multimedia"),
    ("nat", "https://github.com/willdoescode/nat", "CLI Tools"),
    ("nb", "https://github.com/xwmx/nb", "Miscellaneous"),
    ("nls", "https://github.com/nolight132/nls", "CLI Tools"),
    ("NoctaVox", "https://github.com/Jaxx497/NoctaVox", "Multimedia"),
    ("noodle", "https://github.com/wilfredinni/noodle", "CLI Tools"),
    ("parallel-disk-usage", "https://github.com/KSXGitHub/parallel-disk-usage", "Miscellaneous"),
    ("pet", "https://github.com/knqyf263/pet", "Productivity"),
    ("pls", "https://github.com/pls-rs/pls", "CLI Tools"),
    ("riptide", "https://github.com/Foxemsx/riptide", "Dashboards"),
    ("rura", "https://github.com/tlipinski/rura", "CLI Tools"),
    ("sb", "https://github.com/hjelev/sb", "File Managers"),
    ("sheets", "https://github.com/maaslalani/sheets", "CLI Tools"),
    ("sidekick", "https://github.com/mightymoud/sidekick", "Development"),
    ("spotify-tui", "https://github.com/Rigellute/spotify-tui", "Multimedia"),
    ("sshfs", "https://github.com/libfuse/sshfs", "CLI Tools"),
    ("sshs", "https://github.com/quantumsheep/sshs", "Miscellaneous"),
    ("suvadu", "https://github.com/AppachiTech/suvadu", "Shell & Prompt"),
    ("terminal_gameboy", "https://github.com/dquigles/terminal_gameboy", "Games"),
    ("tetrigo", "https://github.com/Broderick-Westrope/tetrigo", "Games"),
    ("tetris", "https://github.com/samtay/tetris", "Games"),
    ("ttl", "https://github.com/lance0/ttl", "Dashboards"),
    ("ttt", "https://github.com/eugenioenko/ttt", "Editors"),
    ("usbtree", "https://github.com/gnomeria/usbtree", "Dashboards"),
    ("walk", "https://github.com/antonmedv/walk", "File Managers"),
    ("wlctl", "https://github.com/aashish-thapa/wlctl", "CLI Tools"),
    ("xan", "https://github.com/medialab/xan", "CLI Tools"),
    ("xleak", "https://github.com/bgreenwell/xleak", "CLI Tools"),
]
